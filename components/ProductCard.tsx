      ...
      <div className="flex flex-1 flex-col p-5 sm:p-6">
        ...
        <div className="mt-auto pt-4">
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-green-700 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-green-800 shadow-sm"
          >
